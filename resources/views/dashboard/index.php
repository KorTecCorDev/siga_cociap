...
$grupos = [
    ...
    'Evaluación y reportes' => [
        ...
        ['roles' => ['admin', 'registro_academico', ...ROLES_DIRECCION], 'url' => 'admin/cuadros/riesgo',  'icon' => 'warning.svg',           'titulo' => 'Estudiantes en riesgo', 'desc' => 'Riesgo académico por grado, sección, área y docente, con informe A4'],
